...
//    unsigned int wallAOMap = loadTexture(FileSystem::getPath("resources/textures/pbr/wall/ao.png").c_str());
    ...
    // ---------------------------------
    std::cout << "loading HDR map...\n";
    stbi_set_flip_vertically_on_load(true);
    int width, height, nrComponents;
    float *data = stbi_loadf(FileSystem::getPath("resources/textures/hdr/Tokyo_BigSight_3k.hdr").c_str(), &width, &height, &nrComponents, 0);
    ...
    std::cout << glm::to_string(captureProjection) << "\n";
    std::cout << glm::to_string(captureViews[0]) << "\n";
