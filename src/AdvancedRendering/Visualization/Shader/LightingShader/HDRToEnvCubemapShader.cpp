...
bool HDRToEnvCubemapShader::Compile() {
    ...
    tex_hdr_symbol_ = glGetUniformLocation(program_, "tex_hdr");
    return true;
}
...
bool HDRToEnvCubemapShader::RenderGeometry(const geometry::Geometry &geometry,
    ...
    GLuint tex_hdr_buffer = lighting_option.tex_hdr_buffer_;
    ...
    glUniform1i(tex_hdr_symbol_, 0);
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, tex_hdr_buffer);
